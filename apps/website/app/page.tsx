  ...
  return (
    <main>
      ...
      <section className="hero shell">
        ...
        <div className="actions"><Link href="/demo" className="button">Try the Sandbox <ArrowRight size={17}/></Link><Link href="/protocol" className="text-link">Read the Protocol</Link></div>
